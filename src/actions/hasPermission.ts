...
export const hasPermissionAction = async (address: string | Buffer, resource: string, operation: string, chainGetter: BaseModuleDataAccess, solver: RBAC): Promise<boolean> => {
